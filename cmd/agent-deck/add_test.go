...
func TestHandleAddUsesGlobalDefaultPath(t *testing.T) {
	...
	writeAddUserConfig(t, home, "default_path = "+strconv.Quote(defaultPath)+"\n")
...
func TestHandleAddGroupDefaultPathPrecedesGlobalDefaultPath(t *testing.T) {
	...
	writeAddUserConfig(t, home, "default_path = "+strconv.Quote(globalPath)+"\n")
...
func TestHandleAddExpandsGlobalDefaultPath(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			writeAddUserConfig(t, home, "default_path = "+strconv.Quote(configPath)+"\n")
...
func TestHandleAddFallsBackToCwdWhenGlobalDefaultPathMissing(t *testing.T) {
	...
	writeAddUserConfig(t, home, "default_path = "+strconv.Quote(missingPath)+"\n")
