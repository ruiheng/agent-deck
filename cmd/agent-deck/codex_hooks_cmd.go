...
func mapCodexNotifyToStatus(event string) string {
	...
	case "userpromptsubmit":
		// UserPromptSubmit runs before Codex accepts the prompt and another
		// matching hook may block it. Record its turn identity, but do not
		// publish a running status until pane/process evidence confirms work.
		return ""
